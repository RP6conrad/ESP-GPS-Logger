...
//  2021: modified by RP6conrad, change so that timestamp file is working in ftp
//  20/02/2022: modified by RP6conrad, Changes for Android, FEAT command comes before login, null-pointer detection (crash if FEAT)
/*******************************************************************************
 **                                                                            **
...
#define FTP_SERVER_VERSION "FTP-2022-02-22"
...
private:
  ...
  boolean feat();				//With Android, FTP command FEAT comes before login !!!
  ...
  char     command[5];              // command sent by client, was 5, JH 18/2/2022
  boolean  rnfrCmd;                   // previous command was RNFR
  char *   parameters;                // point to begin of parameters sent by client
  uint16_t iCL;                       // pointer to cmdLine next incoming char
  //int8_t   cmdStatus,                 // status of ftp command connexion, now public
